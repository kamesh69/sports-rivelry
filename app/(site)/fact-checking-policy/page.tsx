...
export default function FactCheckingPolicyPage() {
  return (
    <InfoPage
      ...
      paragraphs={[
        "The Sports Rivalry checks names, scores, dates, quotes, injury details, standings context, and source framing before publication, especially on fast-moving rivalry and breaking-news pieces.",
